...
mixin _$WorkoutState {
  String get currentExercise => throw _privateConstructorUsedError;
...
abstract class $WorkoutStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String currentExercise, int timeLeft, bool isPaused, bool isCompleted});
}
...
class _$WorkoutStateImpl implements _WorkoutState {
  ...
  @override
  String toString() {
    return 'WorkoutState(currentExercise: $currentExercise, timeLeft: $timeLeft, isPaused: $isPaused, isCompleted: $isCompleted)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, currentExercise, timeLeft, isPaused, isCompleted);
...
abstract class _WorkoutState implements WorkoutState {
  const factory _WorkoutState(
      ...
      final int timeLeft,
      final bool isPaused,
      final bool isCompleted}) = _$WorkoutStateImpl;
